...
# docker run --name mysql -p 3307:3306 -v ./setup:/docker-entrypoint-initdb.d -v ./mysql:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=root -e MYSQL_DATABASE=food_tracker mysql
